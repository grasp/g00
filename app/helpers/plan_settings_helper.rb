...
module PlanSettingsHelper
  ...
  def init_plan_setting
    ...
    @product_fa_tie={"W090"=>["概要需求","概要设计","年度计划","月度计划","首页设计","货物管理","货源管理","车辆管理","定位管理","车源管理","用户管理","公司管理","专线管理","缓存管理","在线支付","广告管理","物信宝服务","帮助中心","访问统计"],
                      "Android"=>["概要需求","概要设计","年度计划","月度计划","W090","GPS","HttpClient","GUI"],
                      "Caiji"=>["概要需求","概要设计","年度计划","月度计划","货源","车源","联系方式","搜索引擎"],
                       "KD090"=>["概要需求","概要设计","年度计划"]
                     }
